            ...
            {cartItems.map(item => (
              <div key={item.id} className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b py-4 last:border-b-0">
                ...
                <div className="flex items-center mt-4 sm:mt-0 w-full sm:w-auto justify-end">
                  ...
                  />
                  <button onClick={() => removeFromCart(item.id)} className="hidden sm:block ml-4 text-red-500 hover:text-red-700 font-semibold text-sm">
                    {t('cart_remove')}
                  </button>
                </div>
              </div>
              ...
              <form onSubmit={handleApplyDiscount} className="mb-4">
                ...
                <div className="flex">
                  <input
                    ...
                    className="w-full rounded-l-md px-3 py-2 border border-gray-300 text-gray-900 focus:outline-none focus:ring-1 focus:ring-amazon-yellow"
                    placeholder="Enter code"
                  />
                  <button type="submit" className="bg-gray-700 hover:bg-gray-800 text-white font-semibold px-4 rounded-r-md transition-colors">
