...
type AdminTab = 'dashboard' | 'users' | 'products' | 'orders' | 'transactions' | 'categories' | 'marketing' | 'settings' | 'content' | 'support' | 'backup';
...
const AdminPage: React.FC = () => {
    ...
    const { user: currentUser, isSuperAdmin, deleteUser, updateUserRole, createUserByAdmin } = useAuth();
        ...
        <div className="container mx-auto px-4 py-8 bg-gray-50 min-h-[70vh]">
            ...
            {isLoading ? (
                ...
                <div className="animate-fade-in">
                    ...
                    {activeTab === 'users' && <AdminUsersTable users={users} currentUser={currentUser} isSuperAdmin={isSuperAdmin} onDeleteUser={handleDeleteUser} onUpdateRole={handleRoleUpdate} onCreateUser={createUserByAdmin} onUserCreated={fetchAdminData} />}
