...
const statusColors: { [key in OrderStatus]: string } = {
    ...
    AwaitingShipment: 'bg-orange-100 text-orange-800',
...
const allStatuses: OrderStatus[] = ['Pending', 'AwaitingShipment', 'PaymentHeld', 'Shipped', 'Delivered', 'Completed', 'Cancelled'];
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('admin_order_user')}</th>
                            ...
                            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('admin_order_total')}</th>
                            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('admin_order_status')}</th>
